...
function split(nid, cb) {
    ...
    `, (err, res) => {
        ...
        for (let seg of segs) {
            ...
            var segLength = turf.lineDistance(seg.network.geometry);
            ...
            if ( segLength !== 0 ) {
                ...
                try {
                    ...
                    throw new Error("Unable to interpolize: " + JSON.stringify({
                        "text": text,
                        "seg": seg,
                        debug: opts.debug,
                        post: opts.post,
                ...
                throw new Error("Unable to interpolize, segment has lenght of zero: " + JSON.stringify({
                    "text": text,
                    "seg": seg,
                    debug: opts.debug,
                    post: opts.post,
